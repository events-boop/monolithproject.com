...
export default function About() {
  ...
  return (
    <div
      ref={containerRef}
      className="bg-[#050505] text-white selection:bg-white/20 relative"
    >
      <SEO
      ...
      <main id="main-content" tabIndex={-1}>
          ...
          >
            ...
            {enableAmbientVideo ? (
              ...
              <ResponsiveImage
                ...
                alt="The Monolith Project hero image at dusk"
                priority
                sizes="100vw"
                loading="eager"
                decoding="async"
          ...
          <div className="absolute inset-0 z-30 flex flex-col items-center justify-center h-full pt-28 md:pt-16 px-8 text-center w-full pointer-events-none">
            ...
            >
              ...
              <p className="max-w-xl text-center text-[11px] uppercase tracking-[0.2em] text-white/70 md:text-base">
                Chicago-rooted house music events, radio, and artist-led
                experiences across open-air afternoons and after-dark rooms.
              </p>
            </motion.div>
        ...
        {/* The Manifesto */}
        <section
          className="relative py-32 md:py-48 px-6 md:px-12 z-30 bg-[#0a0a0a] border-y border-white/[0.05]"
          id="manifesto"
        >
          ...
          <div className="layout-wide flex flex-col lg:flex-row gap-16 lg:gap-24 relative z-10">
            <div className="lg:w-1/3">
              <div className="sticky top-40">
                <span className="section-kicker block text-[#d4a853] mb-4">
                  The Standard
                </span>
                <h2 className="section-display-title-compact mb-6 text-white drop-shadow-md">
                  Manifesto
                </h2>
        ...
        <section
          className="relative px-6 py-28 md:py-36 z-30 border-b border-white/10 bg-[#070707]"
          id="togetherness"
        >
          <div className="layout-wide">
            <div className="max-w-5xl">
              ...
              <p className="max-w-3xl text-lg md:text-xl leading-relaxed text-white/70 font-light">
                Monolith ties together the open-air show, the late-night room,
                and the radio archive. Chasing Sun(Sets) carries golden hour and
                lakefront energy. Untold Story takes the night deeper. Radio
                keeps the artists and community connected between shows.
              </p>
            </div>
        ...
        <section
          className="relative px-6 py-32 md:py-48 z-30 overflow-hidden"
          id="architecture"
        >
                          ...
                          <h3
                            className={`uppercase leading-[0.9] text-white transition-all duration-700 group-hover:translate-x-2 ${
                              expression.label === "Open Air"
                                ? "font-sunsets text-[2.2rem] md:text-[3.2rem]"
                                : expression.label === "Late Night"
                                  ? "font-untold text-[2.2rem] md:text-[3.2rem]"
                                  : expression.label === "Signal"
                                    ? "font-radio text-[2rem] md:text-[2.8rem]"
        ...
        {/* Explore Monolith */}
        <section
          className="relative h-screen flex flex-col items-center justify-center z-30 overflow-hidden"
          id="concept"
        >
          ...
          <div className="relative z-10 text-center flex flex-col items-center max-w-4xl px-4">
            ...
            >
              <MagneticButton strength={0.4}>
                <a
                  ...
                  className="group inline-block w-full max-w-[95vw]"
                >
            ...
            >
              View the next nights, explore the series, or start with the room
