...
const perks = [
  {
    ...
    desc: "Skip the line. Escorted entry for your entire group.",
  },
  {
    icon: Wine,
    title: "Bottle Service",
    desc: "Dedicated server. Premium selection. Sparklers on arrival.",
  },
  {
    icon: Users,
    title: "Private Section",
    desc: "Elevated view of the stage. Your own space in the crowd.",
  },
  {
    icon: Sparkles,
    title: "Concierge",
    desc: "Personal host to handle requests throughout the night.",
  },
];
...
export default function VIP() {
  ...
  const onSubmit = async (data: VipFormValues) => {
    ...
    try {
      ...
      setSubmitError(
        e instanceof Error ? e.message : "Unable to submit request right now."
      );
    } finally {
        ...
        <div className="container layout-default px-4 sm:px-6">
          <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 mb-24">
            ...
            >
              ...
              <div className="absolute inset-0 bg-[#0A0A0A] flex items-center justify-center text-white/70 font-display text-4xl sm:text-6xl uppercase tracking-tighter">
                VIP VIEW
              </div>
            </motion.div>
          </div>
          ...
          <section
            id="vip-request"
            className="max-w-xl mx-auto text-center border-t border-white/10 pt-20"
          >
