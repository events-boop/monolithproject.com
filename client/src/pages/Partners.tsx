...
const productionRoles = [
  {
    ...
    code: "HOSPITALITY",
    description:
      "Experienced bartenders for mobile and venue bars. Craft cocktails and high-volume service.",
  },
  {
    icon: Shield,
    title: "Security",
    code: "SAFETY",
    description:
      "Professional security staff who understand event culture. Keep the vibe safe without killing it.",
  },
  {
    icon: Wrench,
    title: "Stagehands",
    code: "OPS",
    description:
      "Load-in, load-out, stage setup, teardown. Reliable crew who know how to move fast.",
  },
  {
    icon: Camera,
    title: "Media",
    code: "SIGNAL",
    description:
      "Photographers and videographers who capture real moments — not just posed shots.",
  },
  {
    icon: Lightbulb,
    title: "Visuals",
    code: "ATMOS",
    description:
      "Lighting designers and VJ operators. Create atmosphere that matches the music.",
  },
  {
    icon: Drama,
    title: "Performers",
    code: "ENERGY",
    description:
      "Live performers and dancers who add energy to the space. Expressive, not scripted.",
  },
  {
    icon: Music,
    title: "Musicians",
    code: "LIVE",
    description:
      "Percussionists, saxophonists, vocalists — musicians who can jam with DJs and elevate the set.",
  },
  {
    icon: Wrench,
    title: "Engineering",
    code: "SOUND",
    description:
      "FOH and monitor engineers. If you know your way around a PA system, let's talk.",
  },
];
...
const partnerTypes = [
  {
    ...
    inquiryType: "venue",
    description:
      "Rooftops, warehouses, outdoor spaces, clubs — if your space fits the vibe, we'll bring the crowd, sound, and creative direction. We handle production; you provide the setting.",
  },
  {
    icon: Handshake,
    ...
    inquiryType: "sponsor",
    description:
      "We work with brands that want to reach a real, engaged community. Activation spaces, product placement, co-branded experiences — always integrated, never forced.",
  },
];
          ...
          <div className="container layout-default">
            ...
            >
              ...
              <p className="text-white/60 text-lg md:text-2xl max-w-2xl font-light leading-relaxed italic">
                We work with venues, brands, crew, and creative collaborators
                who want to help produce strong shows and reach a real Chicago
                audience.
              </p>
            </motion.div>
          </div>
        ...
        <section className="py-20 px-6 border-t border-white/5">
          <div className="container layout-default">
            <div className="mb-12 max-w-3xl">
              <span className="section-kicker mb-4 block text-primary">
                Ways We Work
              </span>
              ...
              <p className="text-base leading-relaxed text-white/55 md:text-lg">
                The pitch is direct: strong audience energy, clear creative fit,
                and production that protects the room.
              </p>
            </div>
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="mt-auto">
                      <ConversionCTA
                        ...
                        event={{
                          primaryCta: {
                            href: `inquiry://${partner.inquiryType}`,
        ...
        <section className="py-24 md:py-32 px-6 border-t border-white/5 bg-white/[0.01]">
          <div className="container layout-default">
            ...
            >
              <div className="md:w-[65%]">
                ...
                <h2 className="section-display-title-compact text-white">
                  PRODUCTION{" "}
                  <span className="opacity-40 font-light italic">CREW</span>
                </h2>
              </div>
              <p className="text-sm md:text-base text-white/55 w-full md:max-w-sm border-l border-white/10 pl-4 leading-relaxed">
                Operations, hospitality, and stage. The people behind every
                Monolith night — load-in to last call.
              </p>
            </motion.div>
                  ...
                  >
                    ...
                    <div className="relative z-10 h-full flex flex-col justify-between">
                      ...
                      <div className="flex justify-between items-end p-5 bg-[#111111]/60 backdrop-blur-xl border-t border-white/10">
                        <h3 className="font-display text-xl lg:text-2xl text-white uppercase leading-[0.92]">
                          {r.title}
                        </h3>
                        <span
                          aria-hidden
                          className="w-10 h-10 border border-white/20 bg-white/5 group-hover:bg-white/15 text-white flex items-center justify-center transition-colors"
                        >
              ...
              >
                ...
                <div className="relative z-10 h-full flex flex-col justify-between">
                  ...
                  <div className="flex justify-between items-end p-6 bg-[#111111]/60 backdrop-blur-xl border-t border-white/10">
                    ...
                    <span
                      aria-hidden
                      className="w-12 h-12 border border-white/20 bg-white/5 group-hover:bg-white/15 text-white flex items-center justify-center transition-colors"
                    >
            ...
            >
              ...
              <h2 className="section-display-title-compact mb-10 text-white">
                Crew Inquiries
              </h2>
