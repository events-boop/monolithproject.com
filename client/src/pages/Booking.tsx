...
const BookingFormSection = lazy(
  () => import("@/components/BookingFormSection")
);
...
const standards = [
  {
    ...
    label: "Artistry",
    description:
      "We look for artists who can build a room, not just spike energy for a few moments.",
    id: "01",
  },
  {
    icon: ShieldCheck,
    label: "Technicality",
    description:
      "Strong transitions, clean sound, and respect for the booth matter.",
    id: "02",
  },
  {
    icon: Globe,
    label: "Community",
    description:
      "We book people who fit the crowd, the city, and the spirit of the night.",
    id: "03",
  },
];
      ...
      <main className="relative z-10">
        <section className="pt-40 md:pt-56 pb-20 px-6">
          <div className="container layout-default">
            ...
            >
              <h1 className="section-display-title mb-4 text-white">BOOKING</h1>
              ...
              <p className="text-white/60 text-lg md:text-2xl max-w-xl font-light italic leading-relaxed">
                Whether you represent an artist, venue, or brand partner, we
                review every submission for musical fit, room awareness, and
                alignment with the world we build.
              </p>
            </motion.div>
          </div>
        </section>
          ...
          <div className="container layout-narrow">
            ...
            <ViewportLazy minHeightClassName="min-h-[640px]">
              <Suspense
                fallback={
                  <div
                    className="border border-white/5 p-8 md:p-12 min-h-[640px] bg-black/40 rounded-[2.5rem] animate-pulse"
                    aria-hidden="true"
                  />
                }
              >
