...
const pressHighlights = [
  {
    ...
    headline:
      "Monolith Project is redefining Chicago's underground house music experience",
    year: "2025",
  },
  {
    outlet: "Resident Advisor",
    headline:
      "The collectives bringing immersive dance culture back to the Midwest",
    year: "2025",
  },
  {
    outlet: "Chicago Reader",
    headline:
      "Untold Story: The late-night series that Chicago's house heads have been waiting for",
    year: "2024",
  },
];
        ...
        <div className="container layout-default px-6">
          ...
          >
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              <a href="#assets" className="btn-pill-outline btn-pill-compact">
          ...
          <div className="grid lg:grid-cols-12 gap-10 mb-20">
            ...
            >
              ...
              <div className="space-y-4 text-white/60 leading-relaxed">
                <p>
                  The Monolith Project is a Chicago-based music project focused
                  on events, radio, and event archive. Founded in 2024, it
                  operates two flagship series:{" "}
                  <span className="text-white/80">Chasing Sun(Sets)</span> — an
                  open-air golden-hour series — and{" "}
                  <span className="text-white/80">Untold Story</span> — a
                  late-night immersive series.
                </p>
                <p>
                  Rooted in afro house, melodic house, and global rhythms,
                  Monolith events are designed for people who show up early,
                  stay late, and care about the room as much as the lineup.
                </p>
                <p>
                  Based in Chicago, the project has built a reputation for
                  strong sound, intentional production, and a music-first
              ...
              {brandAssets.map((asset, idx) => (
                ...
                >
                  <div
                    ...
                    style={{
                      background: `linear-gradient(to right, ${asset.color}60, transparent)`,
                    }}
                  />
                  ...
                  <h3 className="font-display text-base uppercase text-white mb-1">
                    {asset.label}
                  </h3>
                  <p
