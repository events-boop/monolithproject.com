              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="group relative p-8 border border-border hover:border-primary/30 transition-all duration-500">
                  <div className="h-full flex flex-col">
                    ...
                    <p className="text-muted-foreground text-sm mb-8 flex-grow">
                      Comprehensive overview of The Monolith Project, audience
                      demographics, and tiered partnership opportunities (PDF).
                    </p>
                    <a
                ...
                <div className="group relative p-8 border border-border hover:border-primary/30 transition-all duration-500">
                  <div className="h-full flex flex-col">
                    ...
                    <p className="text-muted-foreground text-sm mb-8 flex-grow">
                      Detailed inventory pricing for experiential activations,
                      digital reach, and hospitality packages (Confidential).
                    </p>
                    <button
                      onClick={() =>
                        toast.info("Inventory Locked", {
                          description:
                            "Rate card inventory is currently being revised for Q3 2026.",
                        })
                      }
