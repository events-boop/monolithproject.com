  ...
  return (
    <div className="relative min-h-screen bg-noise selection:text-white sunset-page">
      <SEO
        ...
        description="SUN(SETS) I brings Kiko Franco, Amari, Erik The DJ, Frank Bono, and Gianni to Castaways Beach Club on July 4th, 2026. Tickets on sale now."
        absoluteTitle
          ...
          <div className="grid gap-4 lg:grid-cols-12">
            ...
            {[
              ...
              },
              {
                kicker: "Schedule",
                title: "Set Times",
                body: "Doors at 12PM. Gianni, Frank Bono, Erik The DJ, and Amari build the day — Kiko Franco takes sunset.",
                href: "#chasing-tickets",
              },
              {
                kicker: "VIP Rail",
                title: "Tables",
                body: SUNSETS_PRELAUNCH_LOCKED
