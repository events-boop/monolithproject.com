...
const ALL_TAGS = Array.from(
  new Set(insightEntries.flatMap(e => e.tags))
).sort();
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white selection:bg-primary selection:text-white bg-scanlines">
      ...
      <main
        id="main-content"
        tabIndex={-1}
        className="page-shell-start-loose pb-24 px-6"
      >
        <div className="container layout-default">
          ...
          >
            ...
            <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-12">
              <p className="max-w-2xl text-lg md:text-xl leading-relaxed text-white/60 italic">
                Clear writing about lineups, show updates, artist context, and
                what is happening around the next Monolith dates.
              </p>
          ...
          {featured ? (
            ...
            >
              <Link
                ...
                className="block relative min-h-[500px] md:min-h-[600px] overflow-hidden"
              >
                ...
                <div className="absolute inset-0 z-10 p-8 md:p-16 flex flex-col justify-end items-start md:max-w-4xl">
                  <div className="flex flex-wrap items-center gap-4 mb-6">
                    <span
                      ...
                      style={{
                        backgroundColor: `${getAccentColor(featured.accent)}22`,
                        color: getAccentColor(featured.accent),
                        border: `1px solid ${getAccentColor(featured.accent)}44`,
                      }}
                    >
                      Featured Insight
                    </span>
                  ...
                  <div className="btn-text-action">Read Full Analysis</div>
                </div>
              </Link>
            </motion.section>
          ) : null}
            ...
            {articles.map((article, index) => (
              ...
              >
                <Link
                  ...
                  className="group flex flex-col h-full rounded-[2rem] overflow-hidden border border-white/10 bg-white/[0.02] hover:bg-white/[0.04] transition-all duration-500"
                >
                  <div className="aspect-[4/5] overflow-hidden relative">
                    ...
                    <div
                      ...
                      style={{
                        backgroundColor: getAccentColor(article.accent),
                        boxShadow: `0 0 10px ${getAccentColor(article.accent)}`,
                      }}
                    />
          ...
          <section className="mt-32 p-12 md:p-20 rounded-[3rem] border border-white/5 bg-gradient-to-br from-white/[0.03] to-transparent text-center">
            <span className="font-mono text-xs tracking-[0.4em] uppercase text-primary mb-6 block">
              Stay Informed
            </span>
            ...
            <Link href="/newsletter" asChild>
              <a className="btn-pill-outline">Join The Newsletter</a>
            </Link>
          </section>
        </div>
      </main>
