        ...
        >
          <section className="container layout-narrow text-center">
            ...
            <p className="text-white/70 mb-8">
              This article is not live yet. Head back to the Journal to browse
              published pieces.
            </p>
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white selection:bg-primary selection:text-white bg-scanlines relative">
      ...
      <main
        id="main-content"
        tabIndex={-1}
        className="relative z-10 page-shell-start-loose pb-24"
      >
        {/* Editorial Header */}
        <motion.section
          ...
          <div className="grid gap-12 lg:grid-cols-[1.2fr_0.8fr] lg:items-end mb-20 md:mb-32">
            <div className="max-w-4xl">
              <div className="flex flex-wrap items-center gap-4 mb-8">
                <span
                  className={`inline-flex items-center rounded-sm border px-4 py-1.5 text-[10px] font-black uppercase tracking-[0.25em] ${accent.chip}`}
                >
                  {article.category}
                </span>
              ...
              <div
                className="h-0.5 w-32 mb-10"
                style={{ backgroundColor: accent.glow || "#DE4B26" }}
              />
        ...
        <div className="container layout-narrow px-6">
          <motion.div
            ...
            {...sectionReveal}
          >
            <p className="text-2xl md:text-3xl font-display uppercase leading-tight text-white italic opacity-90">
              {article.deck}
            </p>
          ...
          >
            ...
            {/* Architectural Aura */}
            <div
              className="absolute -bottom-20 -right-20 w-80 h-80 rounded-full blur-[100px] opacity-[0.05]"
              style={{ backgroundColor: accent.glow || "#DE4B26" }}
            />
          </motion.section>
        </div>
