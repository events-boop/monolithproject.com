...
const lookFor = [
  {
    label: "Sound",
    desc: "Afro house, melodic house, organic house, global rhythms. We don't do generic.",
  },
  {
    label: "Journey",
    desc: "We want selectors who build a story — not just play tracks back to back.",
  },
  {
    label: "Community",
    desc: "Artists who show up for the culture, not just the gig.",
  },
  {
    label: "Professionalism",
    desc: "On time, prepared, and easy to work with. The basics matter.",
  },
  {
    label: "Originality",
    desc: "Your own voice. Your own selections. Not a copy of someone else's set.",
  },
];
...
${form.bio}
      ...
      setError(
        "Something went wrong. Email us directly at bookings@monolithproject.com"
      );
    } finally {
  ...
  const activeColor =
    seriesOptions.find(s => s.id === form.seriesFit)?.color ?? "#E05A3A";
                ...
                {isSubmitted ? (
                  ...
                  >
                    ...
                    <div
                      ...
                      style={{
                        background: `linear-gradient(to right, ${activeColor}80, ${activeColor}20, transparent)`,
                      }}
                    />
                    ...
                    <div className="grid sm:grid-cols-2 gap-6">
                      <div>
                        <label htmlFor="submit-artist" className={labelClass}>
                          Artist Name *
                        </label>
                        <input
                          id="submit-artist"
                      ...
                      <div>
                        <label htmlFor="submit-real" className={labelClass}>
                          Real Name
                        </label>
                        <input
                          id="submit-real"
                    ...
                    <div className="grid sm:grid-cols-2 gap-6">
                      ...
                      <div>
                        <label htmlFor="submit-social" className={labelClass}>
                          Instagram / EPK
                        </label>
                        <input
                          id="submit-social"
                    ...
                    {/* Genres */}
                    <div>
                      <label htmlFor="submit-genres" className={labelClass}>
                        Genres / Sound Description
                      </label>
                      <input
                        id="submit-genres"
                        value={form.genres}
