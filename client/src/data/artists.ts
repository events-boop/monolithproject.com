...
export const ARTIST_ENTRIES: ArtistData[] = [
  ...
  },
  {
    ...
    origin: "CHICAGO, US",
    genre: "HOUSE",
    image: "/images/artists/erik-the-dj/erik-the-dj-live.png",
    imagePosition: "72% 25%",
    series: ["chasing-sunsets"],
    ...
    events: [
      {
        ...
        status: "past",
        badge: "ARCHIVE",
        eventUrl: "/archive/chasing-sunsets-sunsets-ii-2026",
        cardImage: "/images/artists/gene-farris/gene-farris-portrait.jpg",
        description:
          "Chapter Two at Castaways on North Avenue Beach — Gene Farris: Legend on the Lake.",
      },
    ],
  },
];
