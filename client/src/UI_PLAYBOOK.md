...
- **The Conversion Funnel (Tickets) is Always Present:** The "Get Tickets" button isn't a section you scroll to. It is a persistent, beautifully styled, glowing orb or pill that hovers in the corner of the viewport at _all times_, regardless of what overlay or drawer is active.
...
- **Glassmorphism 2.0:** Improve the `.glass` utility. Right now, it's just `backdrop-filter: blur`. We need real "frosted glass" rendering. This involves:
  ...
  - A noise texture masked _only_ to the glass element itself, making it look like physical frosted acrylic.
