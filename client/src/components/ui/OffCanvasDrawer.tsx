...
> = {
  faq: {
    ...
    description:
      "Fast clarity on entry, tickets, tables, and what to expect inside the room.",
    href: "/faq",
    hrefLabel: "Full FAQ",
  },
  newsletter: {
    ...
    title: "Get Updates",
    description:
      "Early ticket windows, lineup drops, and radio episodes before the public post.",
    href: "/newsletter",
  ...
  contact: {
    ...
    description:
      "Artists, crew, venue partners, and aligned brands all funnel through one contact surface.",
    href: "/contact",
  ...
  guide: {
    ...
    description:
      "Everything the room needs before doors: timing, entry rhythm, venue notes, and maps.",
    href: "/guide",
                ...
                <div className="sticky top-0 z-20 border-b border-white/10 bg-black/28 px-6 py-5 backdrop-blur-2xl md:px-8">
                  <div className="flex items-start justify-between gap-4">
                    <div className="max-w-xl">
                      ...
                      <Dialog.Description className="mt-3 max-w-lg text-sm leading-relaxed text-white/60">
                        {meta.description}
                      </Dialog.Description>
                    </div>
                  ...
                  <div className="mt-5">
                    <Link
                      href={meta.href}
                      onClick={() => closeDrawer()}
                      className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.04] px-4 py-2 text-[10px] font-bold uppercase tracking-[0.2em] text-white/80 transition-colors hover:border-white/20 hover:text-white"
                    >
                      {meta.hrefLabel}
