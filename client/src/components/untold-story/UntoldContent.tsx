...
export default function UntoldContent({ event }: { event?: ScheduledEvent }) {
  ...
  return (
    <section
      id="untold-event"
      className="scroll-shell-target py-24 px-6 border-t bg-untold-card-solid border-untold-violet-15"
    >
        ...
        >
          ...
          <div className="relative p-8 md:p-12">
            ...
            <p className="text-white/80 text-lg leading-relaxed max-w-3xl mb-10">
              {event?.description ||
                "A late-night journey through Afro and melodic house led by Chicago's finest selectors in an immersive 360° dancefloor experience."}
            </p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-10 pb-10 border-b border-untold-violet-15">
              ...
              <div className="space-y-2">
                ...
                <p className="text-white text-sm font-medium">
                  {event?.age || "21+ (Valid ID Required)"}
                </p>
              </div>
            </div>
            ...
            <div id="vision" className="scroll-mt-32">
              ...
              <p className="text-white/70 text-base leading-relaxed mb-6">
                {event?.experienceIntro ||
                  "Untold Story is Monolith's late-night series. It is built for tighter rooms, deeper pacing, and a crowd focused on the music from start to finish."}
              </p>
              {!event?.experienceIntro && (
                <p className="text-white/70 text-base leading-relaxed mb-6">
                  The goal is simple: a stronger late-night room with better
                  pacing, clear sound, and a crowd that came for the same
                  reason.
                </p>
              )}
            ...
            {/* Dress Code */}
            <div id="dresscode" className="mb-10 scroll-mt-32">
              <span className="font-mono text-[10px] tracking-widest uppercase block mb-3 text-untold-cyan">
                Dress Code
              </span>
              <p className="text-white/70">
                Elevated nightlife attire encouraged. Dress to move comfortably
                — this is a dancefloor experience.
              </p>
            </div>
            ...
            {/* Tables */}
            <div id="tables" className="mb-10 scroll-mt-32">
              <span className="font-mono text-[10px] tracking-widest uppercase block mb-3 text-untold-cyan">
            ...
            <div className="mb-10">
              <button
                ...
                className="w-full flex items-center justify-between p-6 md:p-8 rounded-2xl bg-white text-[#0B0C10] hover:bg-[#e7e5e4] transition-all duration-300 font-display text-xl md:text-2xl uppercase tracking-wide group shadow-[0_0_30px_rgba(255,255,255,0.15)] hover:shadow-[0_0_50px_rgba(255,255,255,0.3)]"
              >
                ...
                <span className="w-10 h-10 rounded-full bg-black/5 flex items-center justify-center transition-transform duration-500 group-hover:scale-110">
                  <div
                    className={`relative w-4 h-4 transition-transform duration-500 origin-center ${faqOpen ? "rotate-180" : "rotate-0"}`}
                  >
                    <span
                      className={`absolute top-1/2 left-0 w-4 h-[2px] bg-black -translate-y-1/2 transition-transform duration-500`}
                    />
                    <span
                      className={`absolute top-0 left-1/2 w-[2px] h-4 bg-black -translate-x-1/2 transition-transform duration-500 ${faqOpen ? "rotate-90 scale-0" : "rotate-0 scale-100"}`}
                    />
                  </div>
                </span>
              </button>
                    ...
                    <div className="pt-6 space-y-4">
                      {untoldFaqs.map(([q, a], idx) => (
                        ...
                        >
                          ...
                          <p className="text-white/70 mt-4 text-sm leading-relaxed border-t border-white/10 pt-4">
                            {a}
                          </p>
                        </motion.details>
                      ))}
            ...
            <div className="mb-10">
              ...
              <p className="text-white/70 text-sm">
                This event will be photographed and recorded for The Monolith
                Project, House of Friends, and partner marketing channels. By
                entering the venue, you consent to possible use of your likeness
                in event media.
              </p>
            </div>
