        ...
        >
          ...
          <div className="space-y-3">
            ...
            <input
              ...
              className={`w-full bg-transparent border-b pb-2 outline-none ${dark ? "border-white/40 text-white placeholder:text-white/70" : "border-charcoal/30 text-charcoal placeholder:text-charcoal/50"}`}
            />
            <label
