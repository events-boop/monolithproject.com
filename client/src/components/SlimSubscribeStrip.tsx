      ...
      <div className="container max-w-6xl mx-auto relative z-10">
        <form onSubmit={onSubmit} className="grid lg:grid-cols-[1.1fr_1.5fr_auto] gap-4 lg:gap-8 items-center">
          ...
          <button
            type="submit"
            disabled={submitting}
            className={`inline-flex items-center gap-2 px-6 py-3 rounded-full border transition-all ${dark ? "border-white/35 text-white hover:border-primary hover:text-primary" : "border-charcoal/35 text-charcoal hover:border-primary hover:text-primary"} disabled:opacity-50`}
          >
            {ok ? "Subscribed" : submitting ? "Submitting..." : "Subscribe"}
