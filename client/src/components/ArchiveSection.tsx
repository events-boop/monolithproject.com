          ...
          {archiveEntries.map((entry, idx) => (
            ...
            >
              <Link
                ...
                className="group flex flex-col h-full border border-white/10 hover:border-white/20 transition-all duration-500 bg-white/[0.02] hover:bg-white/[0.04] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50"
              >
                {/* Cover Image */}
