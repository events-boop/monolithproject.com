...
export default function NewsletterSection({
  ...
  return (
    <section
      id="newsletter"
      ref={sectionRef}
      className="relative py-24 md:py-32 bg-[#050505] text-white border-t border-white/10"
    >
              ...
              <div className="relative z-10 flex flex-col items-center">
                ...
                <div className="w-full border-y border-white/10 py-10 mb-10 grid md:grid-cols-2 gap-12 text-left">
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <span className="hero-wordmark text-lg text-white/80">
                      Dates, ticket windows, lineup news, and radio drops
                    </span>
                  </div>
                </div>
                ...
                <div className="flex flex-col md:flex-row gap-6 w-full">
                  ...
                  <a href="/" className="btn-pill-outline btn-pill-wide group">
                    <span>Back Home</span>
            ...
            >
              ...
              <div className="flex flex-col">
                ...
                <p className="font-sans text-xl md:text-2xl text-white/80 leading-relaxed font-light mb-12 max-w-xl">
                  Get ticket windows and limited drops before the general
                  public. No generic blasts. Just world-class electronic music
                  in spaces designed for it.
                </p>
