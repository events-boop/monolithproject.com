                ...
                <form onSubmit={handleSubmit} className="relative z-[60] space-y-6 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-md p-6 md:p-7 shadow-2xl" noValidate aria-describedby={submitError ? "newsletter-submit-error" : undefined}>
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full bg-transparent border px-4 py-4 text-white placeholder:text-white/30 focus:outline-none focus:border-white transition-all duration-200 ${touched.email && errors.email ? "border-red-400" : "border-white/20"}`}
                    />
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        placeholder="First"
                        className="w-full bg-transparent border border-white/20 px-4 py-4 text-white placeholder:text-white/30 focus:outline-none focus:border-white transition-all duration-200"
                      />
                    </div>
                    <div>
                  ...
                  <label className="flex items-start gap-3 cursor-pointer group pt-2">
                    ...
                    <span className={`text-xs font-mono tracking-wide group-hover:text-white transition-colors ${touched.agreed && errors.agreed ? "text-red-500" : "text-white/60"}`}>
