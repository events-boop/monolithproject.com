...
export default function EpisodeGallery({
    ...
    return (
        <div className={`py-16 ${isChasing ? "sunset-border-accent" : "border-white/10"}`}>
            <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
                ...
                <div className="flex items-center gap-3">
                    <Link href={`/${series}/gallery/${season.replace(/\s+/g, "-").toLowerCase()}`} asChild>
                        <a
                    ...
                    >
                        ...
                        {img.label && (
                            <div className="absolute bottom-6 left-6 right-6">
                                <span className="font-mono text-[9px] tracking-[0.2em] uppercase text-white/70 block mb-1">
                                    Card {idx + 1}
                                </span>
                        ...
                        {/* Hover Frame Effect */}
                        <div
                            className="absolute inset-0 border-2 opacity-0 group-hover:opacity-100 transition-opacity duration-500 scale-95 group-hover:scale-100 mix-blend-overlay"
