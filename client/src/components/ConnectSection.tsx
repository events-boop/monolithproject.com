...
const connectOptions = [
  {
    ...
    description:
      "We're always looking for artists who fit the sound. Send us your mix and let's talk.",
    link: "/booking",
    delay: 0,
  },
  {
    ...
    description:
      "Bartenders, security, stagehands, lighting techs, dancers — if you help make shows happen, we want to hear from you.",
    link: "/partners",
    delay: 0.1,
  },
  {
    ...
    description:
      "Have a space that fits the vibe? We bring the crowd, the sound, and the creative direction.",
    link: "/partners",
    delay: 0.2,
  },
  {
    ...
    description:
      "Interested in reaching a real community? Let's find a way to work together that feels natural.",
    link: "/sponsors",
    delay: 0.3,
  },
];
...
export default function ConnectSection({
  ...
  return (
    <section
      id="connect"
      className="section-rhythm-tight bg-background relative overflow-hidden"
    >
      {/* Ambient Base Layer */}
      ...
      <div className="container layout-wide px-6 relative z-10">
        ...
        <div
          className={`grid gap-4 ${compact ? "grid-cols-1 sm:grid-cols-2" : "md:grid-cols-2 lg:grid-cols-4"}`}
        >
          {connectOptions.map(option => (
            ...
            >
              <Link
                href={option.link}
                className="block h-full group focus-visible:outline-none rounded-sm"
              >
                <div
                  className={`relative h-full border border-white/5 bg-white/[0.015] backdrop-blur-sm transition-all duration-500 hover:bg-white/[0.03] hover:border-primary/20 flex flex-col group-focus-visible:ring-2 ring-primary/50 overflow-hidden ${compact ? "p-6" : "p-8 md:p-10"}`}
                >
                  {/* Hover Glow Effect */}
                  ...
                  <div className="relative z-10 flex flex-col h-full">
                    ...
                    <div className="flex flex-col gap-2 mb-4">
                      ...
                      <h3
                        className={`font-display text-white leading-[0.85] tracking-wide group-hover:text-white transition-colors ${compact ? "text-2xl md:text-3xl" : "text-3xl md:text-4xl"}`}
                      >
                        {option.title}
                      </h3>
                    </div>
