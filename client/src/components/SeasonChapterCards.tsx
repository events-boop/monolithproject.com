...
const CHAPTER_CARDS = [
  {
    ...
    body: "2,800 on the lakefront. Heat, rain, and the moment the purpose became clear. The recap and archive gallery are live.",
    footer: "Recap + gallery in the archive",
  },
  {
    label: "SUN(SETS) II",
    number: "02",
    ...
    body: "August 22 keeps the season moving — tickets are live, with tables and access windows open.",
    footer: "On sale now",
  },
  {
    label: "SUN(SETS) III",
    ...
    body: "September 19 closes the season with Joezi x Massuma (UK) and special guests still TBA.",
