...
content = content.replace(
  /bg-transparent border border-border rounded-none shadow-sm/g,
  "bg-white/5 border border-white/10 rounded-xl shadow-lg backdrop-blur-md"
);
content = content.replace(
  /bg-transparent border border-border/g,
  "bg-white/5 border border-white/10 rounded-xl shadow-lg backdrop-blur-md"
);

content = content.replace(
  /text-foreground text-background border-foreground/g,
  "text-background border-white"
);
