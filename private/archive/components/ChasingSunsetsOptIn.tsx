        ...
        <>
          ...
          >
            <div
              ...
              style={{
                background:
                  "linear-gradient(145deg, #1A0F00 0%, #2C1810 60%, #1A0A00 100%)",
                border: "1px solid rgba(232,184,109,0.25)",
                boxShadow:
                  "0 0 80px rgba(232,184,109,0.12), 0 32px 64px rgba(0,0,0,0.6)",
              }}
            >
              {/* Top gold glow bar */}
              ...
              <div className="relative px-8 pt-10 pb-8">
                {status === "success" ? (
                  ...
                  >
                    <div
                      className="w-14 h-14 rounded-full border border-[#E8B86D]/40 flex items-center justify-center mx-auto mb-5"
                    ...
                    <p className="text-white/60 text-xs md:text-sm font-mono tracking-widest uppercase mb-6 mt-3">
                      Watch your inbox for new dates, lineup drops, and ticket
                      windows.
                    </p>
                    <a
                  ...
                  <>
                    ...
                    <h2
                      id="cs-optin-title"
                      className="font-display text-3xl md:text-4xl text-white leading-[1.05] mb-3 tracking-wide uppercase"
                    >
                      Get Chasing
                      <br />
                    ...
                    <p className="text-white/60 text-sm leading-relaxed mb-2">
                      Join the newsletter for early access to dates, ticket
                      windows, and lineup announcements.
                    </p>
                    ...
                    <div
                      ...
                      style={{
                        background:
                          "linear-gradient(to right, rgba(232,184,109,0.3), transparent)",
                      }}
                    />
                    ...
                    <form onSubmit={handleSubmit} className="space-y-3">
                      ...
                      <button
                        ...
                        style={{
                          background:
                            "linear-gradient(135deg, #E8B86D, #C2703E)",
                          color: "#1A0F00",
                        }}
                        onMouseEnter={e => {
