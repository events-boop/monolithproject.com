            ...
            <div className="md:w-2/3 space-y-8">
              <div className="space-y-4">
                <div className="flex gap-4">
                  <span className="font-mono text-primary text-sm pt-1">
                    01
                  </span>
                  <p className="text-xl md:text-2xl text-foreground/90 font-light leading-relaxed">
                    A large single block of stone, especially one shaped into or
                ...
                <div className="flex gap-4">
                  ...
                  <p className="text-xl md:text-2xl text-foreground/90 font-light leading-relaxed">
                    Something that shows up, grows, and doesn't go away. Built
                    one show at a time.
                  </p>
                </div>
              </div>
              ...
              <div className="pl-8 border-l-2 border-primary/30">
                <p className="text-muted-foreground italic font-serif">
                  "We're not trying to be everything. We're trying to be one
                  thing — a place where people show up for the music and leave
                  feeling like they were part of something."
                </p>
              </div>
            </div>
          </div>
