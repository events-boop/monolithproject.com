...
const lineupData = [
  { name: "ADRIATIQUE", series: "untold", id: "adriatique" },
  { name: "BEN BÖHMER [LIVE]", series: "sunsets", id: "ben-bohmer" },
  { name: "KEINEMUSIK", series: "sunsets", id: "keinemusik" },
  { name: "MONOLINK [LIVE]", series: "sunsets", id: "monolink" },
  { name: "Aaron Hibell", id: "aaron-hibell" },
  { name: "Acid Pauli", id: "acid-pauli" },
  { name: "Anfisa Letyago", id: "anfisa-letyago" },
  { name: "ANNA", id: "anna" },
  { name: "Arodes", id: "arodes" },
  { name: "ARTBAT", id: "artbat" },
  { name: "Autograf", id: "autograf" },
  { name: "Benchek", series: "radio", id: "benchek" },
  { name: "berlioz", id: "berlioz" },
  { name: "Carlita", id: "carlita" },
  { name: "Chris IDH", series: "radio", id: "chris-idh" },
  { name: "Deer Jade", id: "deer-jade" },
  { name: "Deron B2B Juany Bravo", series: "untold", id: "deron-juany-bravo" },
  { name: "Enfant Sauvage", id: "enfant-sauvage" },
  { name: "Eran Hersh", series: "untold", id: "eran-hersh" },
  { name: "Eric Prydz", id: "eric-prydz" },
  { name: "Ewerseen", series: "radio", id: "ewerseen" },
  { name: "Étienne de Crécy", id: "etienne-de-crecy" },
  { name: "Funk Tribu", id: "funk-tribu" },
  { name: "Ginton", id: "ginton" },
  { name: "Jimi Jules", id: "jimi-jules" },
  { name: "Kasablanca", id: "kasablanca" },
  { name: "Kenya Grace", id: "kenya-grace" },
  { name: "Kerri Chandler", id: "kerri-chandler" },
  { name: "KILIMANJARO", id: "kilimanjaro" },
  { name: "Kölsch", id: "koelsch" },
  { name: "Lane 8", id: "lane-8" },
  { name: "Lazare Sabry", series: "untold", id: "lazare-sabry" },
  { name: "LP Giobbi", id: "lp-giobbi" },
  { name: "Mahmut Orhan", id: "mahmut-orhan" },
  { name: "Marten Lou", id: "marten-lou" },
  { name: "meera", id: "meera" },
  { name: "Michael Bibi", id: "michael-bibi" },
  { name: "Mind Against", id: "mind-against" },
  { name: "Miss Monique", id: "miss-monique" },
  { name: "nimino", id: "nimino" },
  { name: "Parra for Cuva", id: "parra-for-cuva" },
  { name: "Radian OFC", series: "radio", id: "radian-ofc" },
  { name: "Rodrigo Gallardo", id: "rodrigo-gallardo" },
  { name: "Röyksopp", id: "royksopp" },
  { name: "Sammy Virji", id: "sammy-virji" },
  { name: "Summers (UK)", series: "radio", id: "summers-uk" },
  { name: "Terranova", series: "radio", id: "terranova" },
  { name: "Thylacine", id: "thylacine" },
  { name: "Vintage Culture", id: "vintage-culture" },
  { name: "Weval", id: "weval" },
  { name: "YOTTO", id: "yotto" },
];
      ...
      <div className="container layout-wide px-6 relative z-10">
        <div className="flex flex-col lg:flex-row justify-between items-start md:items-end mb-24 gap-12 lg:gap-24">
          <div className="max-w-2xl">
            <span className="ui-kicker block text-white/45 mb-6 font-mono tracking-[0.3em] uppercase">
              Artist Roster
            </span>
            ...
            <p className="font-mono text-[11px] md:text-sm tracking-[0.14em] uppercase text-white/60 leading-relaxed max-w-xl">
              Artists selected for the room, the series, and the pace of the
              night. A lineup should tell you what kind of atmosphere you are
              stepping into, not just who made the poster.
            </p>
          </div>
          ...
          <div className="flex flex-col items-end gap-6 w-full lg:w-auto">
            ...
            >
              <span className="font-mono font-bold tracking-[0.25em] text-xs uppercase">
                Full Historical Lineup
              </span>
        ...
        <motion.div style={{ y }} className="relative">
          <div className="flex flex-wrap items-center justify-center gap-x-6 gap-y-4 md:gap-x-12 md:gap-y-8 text-center">
            {lineupData.map((artist, i) => {
              ...
              let hoverColor =
                "group-hover:text-white group-hover:drop-shadow-[0_0_15px_rgba(224,90,58,0.5)]";
              ...
              if (isRadio) {
                ...
                hoverColor =
                  "group-hover:text-[#22D3EE] group-hover:drop-shadow-[0_0_15px_rgba(34,211,238,0.7)]";
                indicatorColor = "bg-[#22D3EE]";
              } else if (isSunsets) {
                restingColor = "text-[#E8B86D]/80";
                hoverColor =
                  "group-hover:text-[#E8B86D] group-hover:drop-shadow-[0_0_15px_rgba(232,184,109,0.7)]";
                indicatorColor = "bg-[#E8B86D]";
              }

              const img =
                artistImageMap[artist.name] ||
                hoverImages[(i * 3) % hoverImages.length];
              ...
              return (
                ...
                >
                  ...
                  <div
                    className={`absolute -bottom-2 md:-bottom-4 left-0 w-0 h-[2px] ${indicatorColor} transition-all duration-500 ease-out group-hover:w-full`}
                  />
