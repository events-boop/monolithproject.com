...
const MOCK_POSTS: InstagramPost[] = [
  {
    ...
    caption:
      "The energy in the room was unmatched. ✨ #MonolithProject #UntoldStory",
        ...
        <div className="flex flex-col items-center justify-center mb-16 gap-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 w-full max-w-4xl px-4">
            ...
            <div className="flex flex-col items-center text-center space-y-4">
              <h3 className="font-display text-xl text-[#E8B86D] uppercase tracking-widest hidden md:block opacity-80 shadow-orange-500/20 drop-shadow-sm">
                Chasing Sun(Sets)
              </h3>
              <div className="flex flex-col gap-3">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="flex items-center gap-2 text-sm font-mono text-white/70 hover:text-[#E8B86D] transition-colors group"
                >
                  <Instagram className="w-4 h-4 group-hover:scale-110 transition-transform" />
                  <span>@chasingsunsets.music</span>
                </a>
                <a
                  href="https://tiktok.com/@chasingsunsets"
                  target="_blank"
                  rel="noreferrer"
                  className="flex items-center gap-2 text-sm font-mono text-white/70 hover:text-[#E8B86D] transition-colors group"
                >
            ...
            <div className="flex flex-col items-center text-center space-y-5 md:scale-110 origin-top">
              ...
              <div className="flex flex-col gap-3">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="flex items-center gap-2 text-base font-mono text-white hover:text-primary transition-colors group font-bold"
                >
            ...
            {/* Right: Untold Story */}
            <div className="flex flex-col items-center text-center space-y-4">
              <h3 className="font-display text-xl text-[#8B5CF6] uppercase tracking-widest hidden md:block opacity-80 shadow-purple-500/20 drop-shadow-sm">
                Untold Story
              </h3>
              <div className="flex flex-col gap-3">
                <a
                  href={INSTAGRAM_UNTOLD}
                  target="_blank"
                  rel="noreferrer"
                  className="flex items-center gap-2 text-sm font-mono text-white/70 hover:text-[#8B5CF6] transition-colors group"
                >
                  <Instagram className="w-4 h-4 group-hover:scale-110 transition-transform" />
